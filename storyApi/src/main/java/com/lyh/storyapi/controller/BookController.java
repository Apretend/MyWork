...
public class BookController {
    ...
    public ResponseEntity<?> createBook(@RequestBody Book book) {
       try {
           ...
           return ResponseEntity.status(HttpStatus.CREATED).body(new ApiResponse(0, "新建成功",null));
       } catch (Exception e) {
    ...
    public ResponseEntity<?> updateBook(@RequestBody Book book) {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ApiResponse(0,"更新成功",null));
        }catch (Exception e) {
