...
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '书详细信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of book_details
-- ----------------------------
INSERT INTO `book_details` VALUES (12, '3333123根队面叫小军工123', '名存见气位新', '最名安想', '流火状教', '如按一院', '往别放话声律用求声向消色生动究己。区组基利做时专号现积色进现治取下质。传以身任北体张育如之历心片导联并解快。积难去音极最置省此标接两达于性么克。口头当导无并市类族书历那将了克北。以研决向类精展向好王道深形道统统。每相种就应最图千点酸精求拉平立。', 'dolore pariatur', 88, 45, 1, 'est nisi laborum', '2025-01-27 11:54:37', '2025-03-05 11:10:53');
INSERT INTO `book_details` VALUES (13, '领知应圆至速', '国根当面', '天识认压', '至深而去压当节', '厂平术府', '家两千张听家厂满价光新是历两选史正。天六压五数期业除直解他应体。历三水科许报流布克对地至整族按们。见往当量求比人感此知当叫查来是则别备。受花见真建断支门育声又使比存。', 'laboris', 0, 0, 1, 'irure consequat velit ex', '2025-03-04 14:48:47', '2025-03-04 14:48:47');
...
CREATE TABLE `document`  (
  ...
  `document_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '章节数，第几章',
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `document_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '章节名称',
...
-- Records of document
-- ----------------------------
INSERT INTO `document` VALUES (1, '压下亲方两', 1, 'enim reprehenderit consequat', '2025-03-04 15:44:09', '2025-03-04 15:44:09', NULL);
